...
import { APP_NAME, CONFIG_DIR_NAME, ENV_AGENT_DIR, ENV_AUTH_PATH, ENV_SESSION_DIR } from "../config.ts";
...
${chalk.bold("Environment Variables:")}
  ...
  ${ENV_AUTH_PATH.padEnd(32)} - Auth file path (default: $${ENV_AGENT_DIR}/auth.json)
